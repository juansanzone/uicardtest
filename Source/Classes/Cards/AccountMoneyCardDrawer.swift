//
//  AccountMoneyCardDrawer.swift
//  Pods-Example_MeliCardDrawer
//
//  Created by Juan sebastian Sanzone on 5/23/19.
//

import Foundation

@objcMembers public class AccountMoneyCardDrawer: NSObject, CardUI {
    public var placeholderName = ""
    public var placeholderExpiration = ""
    public var bankImage: UIImage?
    public var cardPattern = [0]
    public var cardFontColor: UIColor = UIColor(red: 105 / 255, green: 105 / 255, blue: 105 / 255, alpha: 1)
    public var cardLogoImage: UIImage?
    public var cardBackgroundColor: UIColor = UIColor(red: 0.00, green: 0.64, blue: 0.85, alpha: 1.0)
    public var securityCodeLocation: Location = .back
    public var defaultUI = false
    public var securityCodePattern = 3
    public var fontType: String = "light"
}

extension AccountMoneyCardDrawer {
    static func render(containerView: UIView, balanceText: String, disabledMode: Bool = false) {
        /* TODO JUAN
